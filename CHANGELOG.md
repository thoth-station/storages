...
* :arrow_up: Automatic update of dependencies by Kebechet for the rhel-8 environment
* Release of version 0.60.0
* Allow querying module imports
* Fix typing of end_datetime in purge methods
* Fix import of normalize_os_version
* Removed self.connect() from purge methods
* Add methods to purge old documents and store them on Ceph
* Obtain environment markers based on evaluation result
* :arrow_up: Automatic update of dependencies by Kebechet for the rhel-8 environment
* Add missing types
* Release of version 0.59.0
* :arrow_up: Automatic update of dependencies by Kebechet for the rhel-8 environment
...
* :arrow_up: Automatic update of dependencies by Kebechet
* Release of version 0.49.0
* Introduce query for index bloat data
* Release of version 0.48.0
* :arrow_up: Automatic update of dependencies by Kebechet
...
* Release of version 0.42.0 (#2306)
* :arrow_up: Automatic update of dependencies by Kebechet (#2305)
* :arrow_up: Automatic update of dependencies by Kebechet (#2303)
* Make at least one filter mandatory when deleting package-extract runs (#2302)
* get or create github kebechet installation (#2293)
* :arrow_up: Automatic update of dependencies by Kebechet (#2301)
* Fix referenced variable (#2300)
* :arrow_up: Automatic update of dependencies by Kebechet (#2296)
...
* Release of version 0.41.0 (#2289)
...
* Release of version 0.40.0 (#2280)
...
* Release of version 0.39.3 (#2261)
* :arrow_up: Automatic update of dependencies by Kebechet (#2260)
* Fix/avoid duplicate heads (#2258)
* Release of version 0.39.2 (#2257)
...
* Release of version 0.39.1 (#2247)
...
* Release of version 0.34.0 (#2203)
...
* Release of version 0.33.0 (#2180)
...
* Release of version 0.32.0 (#2174)
...
* Release of version 0.31.0 (#2168)
...
* Release of version 0.30.1 (#2162)
* Correct-output (#2158)
...
* Release of version 0.30.0 (#2152)
* Adjust docstring
* Add get_origin_count_per_source_type method
* Release of version 0.29.4 (#2146)
...
* Release of version 0.29.3 (#2139)
* Use sort() (#2137)
