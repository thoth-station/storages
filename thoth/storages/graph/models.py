...
class PythonPackageVersion(Base, BaseExtension):
    ...
    package_license = Column(Integer, ForeignKey("python_package_license.id"))  # ondelete?  nullable?
    package_license_warning = Column(Boolean, default=False)  # nullable=False
...
class PythonPackageLicense(Base, BaseExtension):
    ...
    # Relations
    python_package_version = relationship("PythonPackageVersion", back_populates="package_license")
