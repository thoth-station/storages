...
def upgrade():
    ...
    op.add_column('kebechet_github_installations', sa.Column('advised_python_software_stack_id', sa.Integer(), nullable=True))
    op.add_column('kebechet_github_installations', sa.Column('external_python_software_stack_id', sa.Integer(), nullable=True))
    op.add_column('kebechet_github_installations', sa.Column('external_software_environment_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'kebechet_github_installations', 'external_software_environment', ['external_software_environment_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'kebechet_github_installations', 'external_python_software_stack', ['external_python_software_stack_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'kebechet_github_installations', 'python_software_stack', ['advised_python_software_stack_id'], ['id'], ondelete='CASCADE')
