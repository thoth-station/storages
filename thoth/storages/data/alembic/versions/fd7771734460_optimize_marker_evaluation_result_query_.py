...
def upgrade():
    ...
    op.alter_column("depends_on", "marker_evaluation_result", existing_type=sa.BOOLEAN(), nullable=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column("depends_on", "marker_evaluation_result", existing_type=sa.BOOLEAN(), nullable=True)
    # ### end Alembic commands ###
